...
export default function FAQPage() {
  ...
  const faqs = [
    ...
    {
      question: "Can I use MedSafe for multiple family members?",
    ...
    {
      question: "Is MedSafe free to use?",
      answer: "MedSafe offers a free forever plan that includes basic features like scanning up to 10 medicines and expiry tracking. Premium plans with unlimited scanning, advanced interaction checking, and priority support are also available."
    },
    {
    ...
    <div className="mx-auto max-w-4xl">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-xl text-black/60">
          Find answers to common questions about MedSafe
        </p>
      </div>
