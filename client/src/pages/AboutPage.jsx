  ...
  return (
    <div className="mx-auto max-w-4xl">
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold mb-4">About MedSafe</h1>
      ...
      <div className="mb-12">
        ...
        <div className="space-y-4 text-black/70 leading-relaxed">
          <p>
            MedSafe was founded in 2023 by a team of healthcare professionals and technologists who 
          ...
          <p>
            Today, MedSafe helps thousands of users worldwide manage their medications confidently, 
