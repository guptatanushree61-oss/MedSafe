...
import { FiTrash2, FiEdit2, FiCheck, FiX, FiAlertTriangle, FiClipboard, FiShield, FiPlusCircle } from "react-icons/fi";
        ...
        {loading ? (
          ...
          <div className="divide-y divide-black/10">
            {items.map((m) => {
              ...
              const medicineInteractions = interactions.filter(
                i => i.drug1 === m.name || i.drug2 === m.name
              );
