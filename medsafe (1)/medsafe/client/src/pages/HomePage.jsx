    ...
    <div className="mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="p-6 border border-black/10 rounded-xl">
            ...
            <p className="text-black/80 mb-4">
              "MedSafe has completely changed how I manage my medications. The interaction checker saved me from a dangerous combination!"
            </p>
      ...
      <div className="text-center py-16">
        ...
        <p className="text-xl text-black/60 mb-8 max-w-2xl mx-auto">
          Join thousands of users who trust MedSafe for their medication management
        </p>
        <Link
          to="/scan"
